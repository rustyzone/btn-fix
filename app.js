...
var parseCoupons = function(coupons, domain) {
 ...
 try{
   ...
   +'<h3 class="h3color">Do you have a coupon for this site?</h3>'
   +'<div class="codeText"><label>Code:</lable><input type="text" class="code"/></div>'
   +'<div class="descText"><label>Description:</label><input type="text" class="desc"/></div>'
